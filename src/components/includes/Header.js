                    ...
                    <div class="row p-4 justify-content-center justify-content-md-between">
                        ...
                        <div class="secondary-info col-auto mt-2">
                            <ul class="resume-social list-unstyled">
                                ...
                                <li><a rel="noreferrer" target="_blank"  class="text-link" href="https://muhammadalidev.com/"><span class="fa-container text-center me-2"><i class="fas fa-globe"></i></span>muhammadalidev.com</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
